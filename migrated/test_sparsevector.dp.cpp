...
int main(void)
{
  ...
  */
  ...
  get_vector_data<<<1, 1>>>(vect1_ptr_d, [] (const VectorInterface *arr) { return arr->size(); }, nshared);
  /*
  ...
  */
  ...
  get_vector_data<<<1, 1>>>(vect1_ptr_d, [] (const VectorInterface *arr) { return arr->size_used(); }, nused);
  /*
  ...
  */
  COPCORE_CUDA_CHECK((dev_ct1.queues_wait_and_throw(), 0));
  get_vector_data<<<1, 1>>>(vect1_ptr_d, [] (const VectorInterface *arr) { return arr->size_used(); },
                            &nused[0]);
  get_vector_data<<<1, 1>>>(vect2_ptr_d, [] (const VectorInterface *arr) { return arr->size_used(); },
                            &nused[1]);
  /*
