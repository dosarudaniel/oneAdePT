...
G4HepEmHostDevice
#endif
static inline double SampleCostModifiedTsai(const double thePrimEkin, G4HepEmRandomEngine* rnge);
...
G4HepEmHostDevice
#endif
static inline void EvaluateLPMFunctions(double& funcXiS, double& funcGS, double& funcPhiS,
